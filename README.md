...
1.  **Random Forest Classification:**
    *   **Target Variable:** The `Import_Export` status was selected as the target variable for prediction.
    *   **Data Splitting:** The dataset was divided into training and testing subsets to evaluate the model's performance.
    *   **Model Training:** A Random Forest classifier was trained using the training data to predict whether a transaction was an import or export.
    *   **Feature Importance Analysis:** The model's feature importances were analyzed to identify which variables had the most significant impact on the predictions.
...
*   **Customer Behavior Patterns:** Identified behavioral patterns within clusters, which can inform tailored marketing and loyalty strategies.
